			...
			<table class="table table-bordered">
				<thead>
					...
					<tbody>
						...
						<c:forEach var="taux" items="${listeTaux}">
							...
							<tr>
								...
								<td>
									<a href="editT?idtaux=<c:out value='${taux.idtaux}' />" 
										class="btn btn-primary btn-sm"
										>
										Modifier
									</a>
										&nbsp;&nbsp;&nbsp;&nbsp; 
									<a href="deleteT?idtaux=<c:out value='${taux.idtaux}' />" 
										class="btn btn-danger btn-sm"
										>
										Supprimer
									</a>
									<a href="readByIdT?idtaux=<c:out value='${taux.idtaux}' />" 
