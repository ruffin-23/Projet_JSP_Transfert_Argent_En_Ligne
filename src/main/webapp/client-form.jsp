			...
			<div class="card-body ">
				...
				<caption>
					<h2 class="text-center ">
						...
						<c:if test="${client == null}">
            			Ajouter un nouveau clientr
            		</c:if>
					</h2>
				</caption><br>
				
				<fieldset class="form-group" >
					<label>Numero telephone</</label> <input type="tel"
						value="<c:out value='${client.numtel}' />" class="form-control"
						name="numtel" required="required">
				</fieldset>
				...
				<fieldset class="form-group">
					<label>Pays</label> <input type="text"
						value="<c:out value='${client.pays}' />" class="form-control"
						name="pays">
				</fieldset>
				
				<fieldset class="form-group">
					<label>Solde</label> <input type="number"
						value="<c:out value='${client.solde}' />" class="form-control"
						name="solde">
				</fieldset>
				
				<fieldset class="form-group">
					<label>Email</label> <input type="text"
						value="<c:out value='${client.mail}' />" class="form-control"
						name="mail">
				</fieldset> <br>
